...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-ocean': 'linear-gradient(135deg, #0c4a6e 0%, #0369a1 50%, #0d9488 100%)',
      ...
      boxShadow: {
        ...
        'panel': '0 0 0 1px rgba(0,0,0,0.05), 0 4px 24px rgba(0,0,0,0.06)',
        'glow-ocean': '0 0 20px rgba(3, 105, 161, 0.15)',
